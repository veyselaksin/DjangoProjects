    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                Lower("name"), name="genre_name_case_insensitive_unique",
...
class Author(models.Model):
    ...
    def display_name(self):
        """ Returns the __str__ method of the Author instance."""
        return self.__str__()
...
class Language(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                Lower("name"), name="language_name_case_insensitive_unique",
